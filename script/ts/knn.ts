function new_center_text(...text : string[]) {
...
var dots_left_group_1 : Animator2.Animation[] = [];
var dots_left_group_2 : Animator2.Animation[] = [];
var dots_left_group_3 : Animator2.Animation[] = [];
var dots_left_group_4 : Animator2.Animation[] = [];
for (let i = 0; i < 20; i++) {
...
var group_2_4 = new Animator2.AnimationQueue(
    new Animator2.AnimationQueue(...dot_left_queue),
    new Animator2.AnimationStep(dots_left_group_1),
    new Animator2.AnimationStep(dots_left_group_2),
    new Animator2.AnimationStep(dots_left_group_3),
    new Animator2.AnimationStep(dots_left_group_4),
);
...
var group_2_5 = new Animator2.AnimationQueue(
    new Animator2.SimpleAnimation(text_regression, "y", ["0", "-40"], 1),
    new Animator2.AnimationQueue(...dots_right_queue),
    new Animator2.SimpleAnimation(fitted_curve, "opacity", ["0", "1"], 1),
)
...
var main = new Animator2.AnimationQueue(
    ...
    group_2_4,
    group_2_5,
    new Animator2.AnimationDelay(2000),
    group_2_6
)